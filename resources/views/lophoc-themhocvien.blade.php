        ...
        <div class="card card-primary">
          <div class="card-body">
            <div class="col-md-12">
              ...
              <div class="form-group col-md-12">
                <label>Số tiền ưu đãi</label>
                <input type="text" class="form-control" name="inputUudai" value="{{ old('inputLichhoc') }}" required>
              </div>
              <div class="form-group col-md-12">
                <label>Số tiền đã thu</label>
                <input type="text" class="form-control" name="inputDadong" value="{{ old('inputGiaovien') }}" required>
              </div>
              <div class="form-group col-md-12">
