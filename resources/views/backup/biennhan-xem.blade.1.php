            ...
            <div class="card-body">
              <div class="col-md-12">
                ...
                <div class="input-group">
                  <input id="inputNoidung" name="inputNoidung" type="text" class="form-control" placeholder="Nhập nội dung..." required>
                  <input id="inputBiennhan" name="inputBiennhan" type="hidden" value="{{$biennhan->id}}"/>
                </div>
                <div class="row my-2">
                  <div class="col-md-8">
                    <div class="checkbox icheck">
                      <label>
                        <input id="inputCongkhai" name="inputCongkhai" type="checkbox"> Công khai cho khách hàng
                      </label>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <input id="postThemnhatky" type="button" class="btn btn-info btn-flat float-right" value="Thêm!"></input>
                  </div>
                </div>
                </form>
              </div>
          ...
          <div class="col-md-6">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-md-3">
                  @if ($biennhan->tiendo)
                  <a href="/xembiennhan/{{$biennhan->id}}/hoanthanh" class="btn btn-success float-right">HOÀN THÀNH</a>
                  @else
                  <a href="/xembiennhan/{{$biennhan->id}}/hoanthanh" class="btn btn-warning float-right">ĐANG XỬ LÝ</a>
                  @endif
                  <i class="float-right">(Click thay đổi)</i>
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
...
$(document).ready(function(){
  ...
  var biennhan = {{$biennhan->id}};
  var congkhai = $('#inputCongkhai').prop('checked');
  var noidung = $('#inputNoidung').val();
  $("#postThemnhatky").click(function(){
    $.post("/nhapnhatky",
    {
      _token: CSRF_TOKEN,
      inputBiennhan: biennhan,
      inputCongkhai: congkhai,
      inputNoidung: noidung
    },
