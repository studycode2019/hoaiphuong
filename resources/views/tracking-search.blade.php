        ...
        <div class="col-md-12">
          <form action="/search" method="post">
            ...
            <div class="input-group">
              <input name="inputKeyword" type="text" class="form-control" placeholder="Nhập vào SỐ PHIẾU hoặc SỐ ĐIỆN THOẠI" required>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <dl class="dl-horizontal">
          ...
          <dd>Trong quá trình sửa chữa, nếu quý khách có bất kỳ câu hỏi hay yêu cầu, hãy gọi cho số điện thoại chăm sóc khách hàng <a href="tel:0888141811">0888.1418.11</a> hoặc <a href="//fb.com/trungtamdoremoncantho" target="_blank">Fanpage Trung tâm Đôrêmon Cần Thơ</a> để được hỗ trợ tốt nhất.</dd>
